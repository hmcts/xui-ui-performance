...
Action()
{
	...
	truclient_step("7", "SelectTabs", "snapshot=Action_7.inf");
	{
		...
		lr_start_transaction("080_SupportTab");
		truclient_step("7.2", "Click on Support tab", "snapshot=Action_7.2.inf");
		lr_end_transaction("080_SupportTab",0);
		lr_start_transaction("090_CaseDocumentsTab");
		truclient_step("7.3", "Click on Case documents tab", "snapshot=Action_7.3.inf");
		lr_end_transaction("090_CaseDocumentsTab",0);
		lr_start_transaction("100_HistoryTab");
		truclient_step("7.4", "Click on History tab", "snapshot=Action_7.4.inf");
		lr_end_transaction("100_HistoryTab",0);
		lr_start_transaction("110_ServiceRequestTab");
		truclient_step("7.5", "Click on Service Request tab", "snapshot=Action_7.5.inf");
		lr_end_transaction("110_ServiceRequestTab",0);
		lr_start_transaction("120_PartiesTab");
		truclient_step("7.6", "Click on Parties tab", "snapshot=Action_7.6.inf");
		lr_end_transaction("120_PartiesTab",0);
	}
