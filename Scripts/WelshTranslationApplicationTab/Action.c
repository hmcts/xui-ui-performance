...
Action()
{
	...
	truclient_step("6", "WelshTranslation", "snapshot=Action_6.inf");
	{
		lr_start_transaction("030_TranslateToWelsh");
		truclient_step("6.1", "Click on Cymraeg JavaScript link", "snapshot=Action_6.1.inf");
	...
	truclient_step("7", "SelectTabs", "snapshot=Action_7.inf");
	{
		...
		lr_start_transaction("090_DogfennauAchosTab");
		truclient_step("7.3", "Click on Dogfennau achos tab", "snapshot=Action_7.3.inf");
		lr_end_transaction("090_DogfennauAchosTab",0);
		lr_start_transaction("100_HanesTab");
		truclient_step("7.4", "Click on Hanes tab", "snapshot=Action_7.4.inf");
		lr_end_transaction("100_HanesTab",0);
