...
Action()
{
	...
	truclient_step("4", "RequestHearing", "snapshot=Action_4.inf");
	{
		...
		truclient_step("4.13", "Type 5 in How many people will... textbox", "snapshot=Action_4.13.inf");
		...
		truclient_step("4.17", "Click on No", "snapshot=Action_4.17.inf");
		truclient_step("4.18", "Click on Circuit Judge listitem", "snapshot=Action_4.18.inf");
		truclient_step("4.19", "Click on District Judge listitem", "snapshot=Action_4.19.inf");
		truclient_step("4.20", "Click on Continue button", "snapshot=Action_4.20.inf");
		truclient_step("4.21", "Type 30 in Minutes textbox", "snapshot=Action_4.21.inf");
		truclient_step("4.22", "Click on No", "snapshot=Action_4.22.inf");
		truclient_step("4.23", "Click on Continue button", "snapshot=Action_4.23.inf");
		truclient_step("4.24", "Click on Continue button", "snapshot=Action_4.24.inf");
		truclient_step("4.25", "Type performance_test in Request a hearing for... textbox", "snapshot=Action_4.25.inf");
		...
		truclient_step("4.27", "Click on Submit request button", "snapshot=Action_4.27.inf");
		lr_end_transaction("XUI02_060_HearingRequestSubmitted",0);
		lr_start_transaction("XUI02_070_Hearings");
		truclient_step("4.28", "Click on view the status of this... link", "snapshot=Action_4.28.inf");
		lr_end_transaction("XUI02_070_Hearings",0);
		lr_start_transaction("XUI02_080_ViewHearing");
		truclient_step("4.29", "Click on View or edit JavaScript link", "snapshot=Action_4.29.inf");
