...
Library_Common()
{
	...
	truclient_step("9", "Function AttachDocument", "snapshot=Common_9.inf");
	{
		...
		truclient_step("9.6", "Wait 3 seconds", "snapshot=Common_9.6.inf");
		truclient_step("9.7", "Click on No", "snapshot=Common_9.7.inf");
		truclient_step("9.8", "Click on No", "snapshot=Common_9.8.inf");
		truclient_step("9.9", "Click on Continue button", "snapshot=Common_9.9.inf");
		lr_start_transaction("XUI04_090_SubmitAttachedDocument");
		truclient_step("9.10", "Click on Save and continue button", "snapshot=Common_9.10.inf");
		lr_end_transaction("XUI04_090_SubmitAttachedDocument",0);
		truclient_step("9.11", "Click on Close and Return to case... button", "snapshot=Common_9.11.inf");
	}
	...
	truclient_step("11", "Function SelectCaseDocumentsPDF", "snapshot=Common_11.inf");
	{
		...
		{
			lr_start_transaction("XUI04_100_CaseDocumentsTab");
			truclient_step("11.2.1", "Click on Case documents tab", "snapshot=Common_11.2.1.inf");
			lr_end_transaction("XUI04_100_CaseDocumentsTab",0);
