...
Action()
{
	truclient_step("1", "Select Case", "snapshot=Action_1.inf");
	{
		...
		truclient_step("1.6", "Evaluate JavaScript code // Get all elements with...' + randomLink);", "snapshot=Action_1.6.inf");
		truclient_step("1.7", "Wait 3 seconds", "snapshot=Action_1.7.inf");
		truclient_step("1.8", "Navigate to randomLink", "snapshot=Action_1.8.inf");
		truclient_step("1.9", "Click on RP/84564/2022 link", "snapshot=Action_1.9.inf");
	}
